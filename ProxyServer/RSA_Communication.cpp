...
RSA_Communication::RSA_Communication(std::string clientPublicKey){
	//this->generateKeys();
...
std::string RSA_Communication::getPrivateKeyFromFile() const{
	std::ifstream privateKeyFile ("private.pem");
...
std::string RSA_Communication::getPublicKeyFromFile() const{
	std::ifstream publicKeyFile ("public.pem");
...
Output: None.
*/
void RSA_Communication::generateKeys(){
